...
/// 普通宝箱生成器
/// </summary>
public class PurpleChestMarkGenerator : BaseMarkPointGenerator
{
    public PurpleChestMarkGenerator(Scene targetScene, string tilemapName, GameObject chestPrefab)
    ...
    protected override void RecordToLevelSystem(List<Vector3> positions)
    {
        foreach (var pos in positions)
        {
            PlainLevelSystem.Instance.AddPurpleChestPosition(pos);
        }
    }
}
