...
/// <summary>
/// 商店生成器（1x2连续，当前格子和右边格子都存在才有效）
/// </summary>
public class StoreMarkGenerator : BaseMarkPointGenerator
{
    public StoreMarkGenerator(Scene targetScene, string tilemapName, GameObject storePrefab)
        : base(targetScene, tilemapName, storePrefab) { }
