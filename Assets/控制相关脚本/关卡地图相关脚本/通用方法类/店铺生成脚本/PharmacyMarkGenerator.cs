...
/// <summary>
/// 药店生成器（1x2连续，当前格子和右边格子都存在才有效）
/// </summary>
public class PharmacyMarkGenerator : BaseMarkPointGenerator
{
     public PharmacyMarkGenerator(Scene targetScene, string tilemapName, GameObject pharmacyPrefab) 
        : base(targetScene, tilemapName, pharmacyPrefab) { }
